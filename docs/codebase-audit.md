...
size: 12 regions, 36 sublocations, 55 NPCs, 46 quests, 31 items, 9 recipes, and
...
| Narrative progression     | The world systems were available immediately but lacked a compulsory onboarding loop or unifying campaign.                                    | Added Cleveland-only onboarding, an inventory-backed contractor credential travel gate, action-driven quest objectives across all twelve cities, and five persistent endings. |
...
- Content validation: 55 NPCs, 46 quests, 12 regions, 36 sublocations, 31 items,
